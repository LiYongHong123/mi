            ...
            <div class="addr-list clearfix">
              ...
              >
                ...
                <div class="action">
                  ...
                  <a href="javascript:;" class="fr" @click="editAddressModa(item)">
              ...
              <div class="addr-add" @click="openAddressModa">
        ...
        <div class="edit-wrap">
          ...
          <div class="item">
            ...
            <select name="province" v-model="checkedItem.receiverProvince">
              <option value autofocus>--请选择--</option>
  ...
  methods: {
    ...
    getCartList() {
      this.axios.get("/carts").then(res => {
        ...
        this.cartTotalPrice = res.cartTotalPrice; //商品总金额,选中的商品的总金额
        // 过滤出以选中的商品
    ...
    orderSubmit() {
      ...
      // 跳转路径的3种方式
      // 1,直接在push()参数里写url地址
      // 2,使用push()参数写一个对象，路径使用pash搭配query使用
      // 3,使用push()参数写一个对象，路径使用name,name不是路径，是路由的名字,搭配parpms使用
    }
  }
};
</script>
